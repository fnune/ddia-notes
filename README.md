...
- [Part 1: Fundamentals](#part-1-fundamentals)
  - [x] [Chapter 1: reliability, scalability and maintainability](#chapter-1-reliability-scalability-and-maintainability)
  - [x] [Chapter 2: data models and query languages](#chapter-2-data-models-and-query-languages)
  - [x] [Chapter 3: storage engines](#chapter-3-storage-engines)
...
- [Part 2: Distributed Systems](#part-2-distributed-systems)
  ...
  - [ ] [Chapter 6: partitioning/sharding](#chapter-6-partitioningsharding)
